This project extracts and analyzes gene sequences from GenBank files (.gbff) and retrieves corresponding protein structures from the Protein Data Bank (PDB). It includes:
